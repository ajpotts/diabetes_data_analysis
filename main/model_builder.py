...
class ModelBuilder(object):
    ...
    #     hc_model = mlrose.NeuralNetwork(hidden_nodes=hidden_nodes, activation=activation, \
    #                                  algorithm='random_hill_climb', max_iters=max_iters, \
    #                                  bias=bias, is_classifier=True, learning_rate=best_hc_rate, \
    #                                  early_stopping=False, clip_max=clip_max, max_attempts=max_attempts, \
    #                                  restarts=restarts,
    #                                  curve=True,
    #                                  random_state=1)
    ...
    #
    #     sa_model = mlrose.NeuralNetwork(hidden_nodes=hidden_nodes, activation=activation, \
    #                                  algorithm='simulated_annealing', max_iters=max_iters, \
    #                                  bias=bias, is_classifier=True, learning_rate=best_sa_rate, \
    #                                  early_stopping=False, clip_max=clip_max, max_attempts=max_attempts, \
    #                                 curve=True,
    #                                  random_state=1)
    #
